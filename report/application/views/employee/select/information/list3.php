		 ...
		 <div id="content" class="clear">
            <div id="main" class="clear">
                <div id="head" class="clear">
				  ...
				  <form id="formEditor" name="formEditor" class="mainForm clear"  method="post" <?php echo form_open('index.php/report/get_pdf_form3/'.$id);?>
                    <fieldset class="clear">
						...
						<div class="field clear">
                            <span class="label">Name of manager 1: <span class="star">*</span></span>
						...
						<div class="field clear">
                             <span class="label">Name of manager 2: <span class="star">*</span></span>
							<select id="selSingleDropdown" name="name_manager2" class="medium">
							  <option selected="selected">-- select --</option></center>
								<?php for ( $num8 = 0; $num8 < count($manager); $num8++) {?>
								<?php if ($manager[$num8]->name_thai != ""):?>
                                <option value="<?php echo $manager[$num8]->name_thai." ".$manager[$num8]->lastname_thai; ?>"><?php echo $manager[$num8]->name_thai." ".$manager[$num8]->lastname_thai; ?></option>
								<?php endif;?>
                                <?php } ?>
                            </select>
                        </div>
						<div class="field clear">
                            <label for="selSingleDropdown">Witness 1: <span class="star">*</span></label>
                            <select id="selSingleDropdown" name="witness" class="medium">
                                <option selected="selected">-- select --</option>
								<?php for ( $num7 = 0; $num7 < count($witness); $num7++) {?>
                                <option value="<?php echo $witness[$num7]->name_thai." ".$witness[$num7]->lastname_thai; ?>"><?php echo $witness[$num7]->name_thai." ".$witness[$num7]->lastname_thai; ?></option>
                                <?php } ?>
                            </select>
                        </div>
						<div class="field clear">
                            <label for="selSingleDropdown">Witness 2: <span class="star">*</span></label>
                            <select id="selSingleDropdown" name="witness2" class="medium">
                                <option selected="selected">-- select --</option>
								<?php for ( $num9 = 0; $num9 < count($witness); $num9++) {?>
                                <option value="<?php echo $witness[$num9]->name_thai." ".$witness[$num9]->lastname_thai; ?>"><?php echo $witness[$num9]->name_thai." ".$witness[$num9]->lastname_thai; ?></option>
                                <?php } ?>
                            </select>
                        </div>
						<div class="field clear">						 
							 <input name="check" type="radio" value="1" checked="checked" />
							 <font size = "2">สัญญาจ้างงาน</font>
							 <br><br>
							<input name="check" type="radio" value="2" />
							<font size = "2">	สัญญาจ้างงาน (ทดลองงาน)</font>			
						   </div>
